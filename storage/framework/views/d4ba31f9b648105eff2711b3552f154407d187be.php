                        ...
                        <tbody>
                            <?php if(count($albums) > 0): ?>
                                <?php $__currentLoopData = $albums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($album->album->id); ?></td>
                                        <td><?php echo e($album->album->nombre); ?></td>
                                        <td><?php echo e($album->album->descripcion); ?></td>
                                        <td><img src='<?php echo e(asset("/img/albums/{$album->album->imagen}")); ?>' alt="" style="width:70px"></td>
                                        ...
                                        <td class="d-flex justify-content-around" >
                                            <button class= "btn btn-round  btn-primary btnEditar"
                                                    ...
                                                    data-imagen="<?php echo e($album->imagen ? asset("/img/albums/{$album->imagen}"): ''); ?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php $__currentLoopData = $tematicas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tematica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-group">
                            <input type="checkbox" name="tematica_id[]" value= "<?php echo e($tematica->id); ?>"/>
                            <label for="tematica_id"><?php echo e($tematica->nombre); ?></label>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Ayuda compañeros\EconoTest\resources\views/albumAdmin/index.blade.php ENDPATH**/ ?>